...
** TODO not too urgent
  ...
  - [ ] make train to be able to stop less than a full epoch (10-11)
  - [ ] update draft for real experiments and introduction (11-2)

   SCHEDULED: <2020-05-31 Sun>
  - [ ] run a small n experiment of MIMIC-III to make sure no bugs 
  - [ ] look at validation data: debug

** Future
  - [ ] (later) refactor the pipeline for general training; later could add in hao's idea
  - [ ] think about tune.py how to record error
  - [ ] add a progress bar to train
=======
  - [ ] get result that jenna want: make mtl or what a hyper parameter; make
    dependent and independent as a hyperparameter
>>>>>>> 8d897873db24b4a344b8a5a3e0dddd93ecd3362c
