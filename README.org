...
* TODO left to finish
  ...
  - [ ] refactor the pipeline for general training; later could add in hao's idea
  - [-] rewrite data loading to using dataset
    - [ ] preprocess to save X and Y
  ...
  - [ ] run a small n experiment of MIMIC-III to make sure no bug
