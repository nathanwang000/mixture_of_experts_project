...
- [-] hyperparameter search: create a setting_bank (a pkl file of list of
  ...
  - [ ] the cluster side: random search; do this for AE, INPUT (too slow, maybe omit), GLOBAL,
    ...
    - [ ] pmt: search this after having the best global model
    - [ ] not_pt: this requires having the best global model as well
    - [ ] ae_epoch: 100 # probably don't change this
    - [ ] gmm_tol: 0.0001 # probably don't change this
